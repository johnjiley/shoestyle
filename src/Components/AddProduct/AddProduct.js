...
function AddProduct() {
  const { addProduct } = useContext(ProductContext); // Use addProduct from context
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Adding product:", newShoe); // Debugging log
    addProduct(newShoe); // Call addProduct to add the new product to the context
